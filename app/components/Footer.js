      ...
      <footer className="bg-white">
        <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
          <div className="mx-auto max-w-2xl text-center">
            <hgroup>
              <h2 className="text-base/7 font-semibold text-indigo-600">Compare now</h2>
              <p className="mt-2 text-balance text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
                Compare local survey quotes online in minutes.
              </p>
            </hgroup>
            <p className="mx-auto mt-6 max-w-xl text-pretty text-lg/8 text-gray-600">
              Easily find and compare quotes from local surveyors for your next property purchase in minutes.
            </p>
